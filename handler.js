...
export async function participantsUpdate({ id, participants, action }) {
        ...
        case 'remove':
            if (chat.welcome) {
                ...
                for (let user of participants) {
                    let pp = 'https://telegra.ph/file/61de20af3fb1e4826eabf.jpg'
                    try {
                        ...
                        let wel = API('males', '/welcome2', {
                                ...
                                background: 'https://telegra.ph/file/61de20af3fb1e4826eabf.jpg',
 ...
 /* conn.sendButtonDoc(id, wm, text, action == 'add' ? 'ᴡᴇʟᴄᴏᴍᴇ' : 'sᴀʏᴏɴᴀʀᴀᴀ', action === 'add' ? '.intro' : 'Aʟᴅɪ X Aɪsʏᴀʜ', fkontak, { contextInfo: { externalAdReply: { showAdAttribution: true,
  ...
  let welcom = 'https://telegra.ph/file/61de20af3fb1e4826eabf.jpg'

  let godbye = 'https://telegra.ph/file/61de20af3fb1e4826eabf.jpg'
  conn.sendButtonImg(id, await(await fetch(action === 'add' ? wel : lea)).buffer(), 'Group Messege', text, action == 'add' ? 'ᴡᴇʟᴄᴏᴍᴇ' : 'sᴀʏᴏɴᴀʀᴀᴀ', action === 'add' ? '.intro' : 'ANNA BOT', fakes, { contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: 'https://www.instagram.com/shizu_bot/',
    mediaType: 2, 
    description: sgc,
    title: "Jᴏɪɴ Sɪɴɪ Cᴜʏ",
    body: wm,
